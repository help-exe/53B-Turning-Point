...
// ----AUTONOMOUS FUNCTION PROTOTYPES----
  void rightDefault();
  void leftDefault();
  void rightStretch();
  void leftStretch();
  ...
  string autonNames[] = {"rightDefault", "leftDefault ", "rightStretch", "leftStretch "};
// ----AUTONOMOUS FUNCTION PROTOTYPES----
...
void pre_auton(void) {
  ...
  Controller1.Screen.print("===Auton Selector===");
  printAuton();
  Controller1.Screen.setCursor(3,1);
  Controller1.Screen.print("====================");

  Controller1.ButtonLeft.pressed(changeAutonDown);
  Controller1.ButtonRight.pressed(changeAutonUp);
...
// ----PREAUTONOMOUS FUNCTIONS----
  ...
  void changeAutonDown() {
    if(!isUsercontrol) {
      Controller1.rumble(".");
      if(autonChoice > 1) autonChoice--;
      else autonChoice = autonLimit;
      printAuton();
    }
  }
  ...
  void printAuton() {
    ...
    Controller1.Screen.print("|<-L- -R->| %s", (autonNames[autonChoice-1]).c_str());
  }
// ----PREAUTONOMOUS FUNCTIONS----
...
// ----CALLBACK FUNCTIONS----
  ...
  void togglePrint() {
    ...
    Controller1.Screen.setCursor(3,1);
    Controller1.Screen.print(printChoice);
  }
// ----CALLBACK FUNCTIONS----
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    // ----Print Statements----
      ...
      /*
      Controller1.Screen.setCursor(1,1);
      Controller1.Screen.print("Please");
      ...
      Controller1.Screen.setCursor(1,1);
      Controller1.Screen.print(timeCt);
